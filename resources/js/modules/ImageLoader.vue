<template>
    <transition name="fade">
        ...
        >
            ...
            <div
                class="actions-grid absolute pin-t pin-r pr-2 pt-2 pb-1 pl-2"
            ...
            <td>
                ...
                <div class="w-full h-full flex justify-center items-center">
                    ...
                    <div
                        v-if="file.mime == 'image'"
                        ref="image"
                        class="image-block block w-full h-full"
                    >
                        <lazy-component>
                            <img :src="file.thumb" class="block w-full h-full object-cover" />
                        </lazy-component>
